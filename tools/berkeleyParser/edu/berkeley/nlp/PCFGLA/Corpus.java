...
public class Corpus {
	...
	public static final int CONLL = 6;
	 ...
	 */
	public Corpus(String path, int lang, double fraction, boolean onlyTest) {
		this(path, lang, onlyTest);
	 ...
	 */
	private Corpus(String path, int lang, boolean onlyTest) {
		myLanguage = lang;
...
//sentences.add("((S (NP (NP (DT No) (NN fiddling)) (PP (IN with) (NP (NNS systems) (CC and) (NNS procedures)))) (VP (MD will) (ADVP (RB ever)) (VP (VB prevent) (NP (NNS markets)) (PP (IN from) (S (VP (VBG suffering) (NP (NP (DT a) (NN panic) (NN wave)) (PP (IN of) (NP (NN selling))))))))) (. .)))");
	...
	private void loadWSJ(String pathWSJ,boolean onlyTest) throws Exception {
		...
		if (!onlyTest) {
			trainTrees.addAll(readTrees(pathWSJ, 1, 2,Charset.defaultCharset())); // was 200, 2199
			validationTrees.addAll(readTrees(pathWSJ, 1, 2,Charset.defaultCharset())); // was 2100, 2199
		}
  ...
  public static List<Tree<String>> binarizeAndFilterTrees(
    ...
    for (Tree<String> tree : trees) {
      ...
      if (true) {
        binarizedTrees.add(TreeAnnotations.processTree(tree,verticalAnnotations,horizontalAnnotations,binarization,manualAnnotation));
      } else {
