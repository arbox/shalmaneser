...
public class TreeJPanel extends JPanel {
  ...
  public static void main(String[] args) throws IOException {
    ...
    Tree tree = (new Trees.PennTreeReader(new StringReader(ptbTreeString))).next();//new StringReader(ptbTreeString), new LabeledScoredTreeFactory(new StringLabelFactory()))).readTree();
    tjp.setTree(tree);
