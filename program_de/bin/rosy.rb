...
require "RosyFeaturize"
require "RosyTrain"
require "RosyTest"
require "RosyInspect"
require "RosyEval"
require "RosyServices"
...
def options_hash(opts_obj) # GetoptLong object
  opt_hash = Hash.new
...
#rescue
#  database.close()
#  raise "Error during task initialization: " + $!
#end
...
#rescue
#  database.close()
#  raise "Error during task execution: " + $!
#end
