...
require_relative 'select_table_and_columns'
  ...
  module DB
    ...
    class DBView
      ...
      def execute_command(command)
        @db_obj.query(command)
      # @todo AB: [2016-09-13 Tue 16:04]
      #       Here was a hardcoded MysqlError
      #       We have to introduce a generic External Error for databases.
      #       An Ensure Clause is important.
      rescue => e
