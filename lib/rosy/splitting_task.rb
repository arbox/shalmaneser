    ...
    class SplittingTask < Task
      ...
      def self.make_join_restriction(splitID,  # string: splitlogID
        ...
        VarVarRestriction.new(table.table_name + "." + table.index_name,
                              ttt_obj.splittable_name(splitID, dataset) + "." + SplittingTask.split_index_colname)
      end
      ...
      def perform_make_split
        ...
        split_train_table = @ttt_obj.new_split_table(@split_id, "train", SplittingTask.split_index_colname)
        split_test_table =  @ttt_obj.new_split_table(@split_id, "test", SplittingTask.split_index_colname)
        ...
        iterator.each_group do |dummy1, dummy2|
          ...
          view.each_sentence do |sentence|
            ...
            sentence.each do |instance|
              table.insert_row([[SplittingTask.split_index_colname, instance[maintable.index_name]],
