  ...
  module Rosy
    class TrainingTask < Task
      ...
      def perform_aux
        ...
        if @step == "arglab" && not(@exp.get("assume_argrec_perfect"))
        ...
        # hand all the info to the Iterator object
        # It will figure out what view I'll need.
        #
        # prune = true: If pruning has been enabled,
        # Iterator will add the appropriate DB column restrictions
